 ...
 *
 * <p>This annotation is used in conjunction with {@link com.google.errorprone.annotations.FormatString} to denote a method that takes
 * a printf-style format string and its format arguments. In any method annotated as {@code
 * FormatMethod} without a {@link com.google.errorprone.annotations.FormatString} parameter, the first {@code String} parameter is
 ...
 * }</pre>
 *
 * <p>Using {@link com.google.errorprone.annotations.FormatMethod} on a method header will ensure the following for the parameters
 * passed to the method:
 *
 * <ol>
 *   <li>A format string is either:
 *       <ul>
 *         <li>A compile time constant value (see {@link com.google.errorprone.annotations.CompileTimeConstant} for more info).
 ...
 * log(format, arg);
 * }</pre>
 *         <li>Another {@link com.google.errorprone.annotations.FormatString} annotated parameter. Ex:
 *             <pre>{@code
 * public class Foo {
 *   static final String staticFinalLogMessage = "foo";
 *   &#064;FormatMethod void log(&#064;FormatString String format, Object... args) {}
 ...
 *       com.google.errorprone.annotations.FormatString} itself, this will ensure that the types of the arguments passed to the callee
