 ...
 *
 * <p>For example, {@link java.util.Collection#contains} would be annotated as follows:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>To indicate that invocations of {@link java.util.Collection#contains} must be passed an argument whose
