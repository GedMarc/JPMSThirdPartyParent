 ...
 * non-{@code @}{@link org.checkerframework.dataflow.qual.SideEffectFree} method call intervenes). For example, the following code
 ...
 *
 * <p>Also see {@link org.checkerframework.dataflow.qual.Pure}, which means both deterministic and {@link org.checkerframework.dataflow.qual.SideEffectFree}.
 *
 ...
 *   <li>A method invocation of a method that is not {@link org.checkerframework.dataflow.qual.Deterministic}.
 ...
 * also {@link org.checkerframework.dataflow.qual.SideEffectFree}. This might change in the future; in general, a deterministic method
