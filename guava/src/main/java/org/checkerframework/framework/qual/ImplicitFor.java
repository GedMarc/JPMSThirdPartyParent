...
public @interface ImplicitFor {
    ...
    /**
     * @return {@link org.checkerframework.framework.qual.LiteralKind}s for which an annotation should be implicitly added. For example,
    ...
    /** @return {@link org.checkerframework.framework.qual.TypeKind}s of types for which an annotation should be implicitly added */
