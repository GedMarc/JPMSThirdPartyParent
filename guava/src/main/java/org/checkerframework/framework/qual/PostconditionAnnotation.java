 ...
 * type-specialized version of {@link org.checkerframework.framework.qual.EnsuresQualifier}. The value {@code qualifier} that is
 * necessary for a postcondition specified with {@link org.checkerframework.framework.qual.EnsuresQualifier} is specified here with the
 * value {@code qualifier}.
 *
 * <p>The annotation E that is meta-annotated as {@link org.checkerframework.framework.qual.PostconditionAnnotation} must have an
 * element called {@code value} that is an array of {@code String}s of the same format and with the
 * same meaning as the value {@code expression} in {@link org.checkerframework.framework.qual.EnsuresQualifier}.
 *
