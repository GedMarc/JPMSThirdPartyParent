 ...
 * to source code not annotated with {@link org.checkerframework.framework.qual.AnnotatedFor} for the checker being executed.
 *
 * <p>Note, this annotation is analogous to {@link org.checkerframework.framework.qual.DefaultFor} but for unannotated type uses in code
 * that has not been type-checked. This qualifier is for type system developers, not end-users.
 *
 * @see org.checkerframework.framework.qual.AnnotatedFor
 * @see org.checkerframework.framework.qual.DefaultQualifier
 * @see org.checkerframework.framework.qual.DefaultQualifierInHierarchyInUncheckedCode
