 ...
 *
 * <p>{@code @LockingFree} provides a stronger guarantee than {@code @}{@link org.checkerframework.checker.lock.qual.ReleasesNoLocks} and a
 * weaker guarantee than {@code @}{@link SideEffectFree}.
 *
 * @see org.checkerframework.checker.lock.qual.MayReleaseLocks
 * @see org.checkerframework.checker.lock.qual.ReleasesNoLocks
 * @see SideEffectFree
 * @see Pure
