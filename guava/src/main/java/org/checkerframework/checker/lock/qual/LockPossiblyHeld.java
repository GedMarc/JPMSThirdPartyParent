...
/**
 * Indicates that an expression is not known to be {@link org.checkerframework.checker.lock.qual.LockHeld}.
 *
 * <p>This annotation may not be written in source code; it is an implementation detail of the
 * checker.
 *
 * @see org.checkerframework.checker.lock.qual.LockHeld
