 ...
 *
 * <p>Binary names and {@linkplain org.checkerframework.checker.signature.qual.InternalForm internal form} only differ by the use of '.' vs. '/'
 * as package separator.
 *
 * <p>The binary name should not be confused with the {@linkplain org.checkerframework.checker.signature.qual.InternalForm internal form}, which
