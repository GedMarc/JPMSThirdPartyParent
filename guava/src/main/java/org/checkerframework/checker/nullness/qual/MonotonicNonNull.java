 ...
 *
 * <p>{@code MonotonicNonNull} gives stronger guarantees than {@link org.checkerframework.checker.nullness.qual.Nullable}. After a check that a
 * {@link org.checkerframework.checker.nullness.qual.Nullable} field holds a non-null value, only accesses until the next non-{@link
 ...
 * particular method is called, use {@link org.checkerframework.checker.nullness.qual.RequiresNonNull}.
 *
 ...
 *
 * @see org.checkerframework.checker.nullness.qual.EnsuresNonNull
 * @see org.checkerframework.checker.nullness.qual.RequiresNonNull
