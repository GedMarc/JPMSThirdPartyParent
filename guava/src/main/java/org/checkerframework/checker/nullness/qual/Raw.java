 ...
 * initialization of {@link org.checkerframework.checker.nullness.qual.NonNull} fields.
 *
 ...
 * org.checkerframework.checker.nullness.NullnessRawnessChecker} considers {@link org.checkerframework.checker.nullness.qual.NonNull}.
 *
 * <p>Therefore, reading a field of an object of type {@link org.checkerframework.checker.nullness.qual.Raw} might yield a value that does not
 ...
 * if it has been annotated as {@link org.checkerframework.checker.nullness.qual.NonNull}.
 *
 ...
 * {@link org.checkerframework.checker.nullness.qual.Raw Raw(<em>supertype</em>)} is used as the type of the self-reference {@code this}.
 ...
 * Raw(<em>supertype</em>)}.
 *
 * <p>Note that it would not be sound to type {@code this} as {@link org.checkerframework.checker.nullness.qual.NonRaw} anywhere in a
