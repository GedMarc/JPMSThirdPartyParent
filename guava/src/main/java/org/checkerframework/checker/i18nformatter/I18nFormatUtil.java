...
public class I18nFormatUtil {
    ...
    /**
     * Returns a {@link org.checkerframework.checker.i18nformatter.qual.I18nConversionCategory} for every conversion found in the format string.
     *
     * @param format the format string to parse
     * @throws java.util.IllegalFormatException if the format is not syntactically valid
     */
     ...
     * passed {@link org.checkerframework.checker.i18nformatter.qual.I18nConversionCategory}s. Otherwise an error is thrown.
     *
