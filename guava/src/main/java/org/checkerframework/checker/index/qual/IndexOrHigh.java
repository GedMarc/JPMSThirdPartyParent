 ...
 * }</pre>
 *
 * <p>Writing {@code @IndexOrHigh("arr")} is equivalent to writing {@link org.checkerframework.checker.index.qual.NonNegative @NonNegative}
 * {@link org.checkerframework.checker.index.qual.LTEqLengthOf @LTEqLengthOf("arr")}, and that is how it is treated internally by the
