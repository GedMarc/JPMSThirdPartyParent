 ...
 * }</pre>
 *
 * <p>Writing {@code @IndexFor("arr")} is equivalent to writing {@link org.checkerframework.checker.index.qual.NonNegative @NonNegative}
 * {@link org.checkerframework.checker.index.qual.LTLengthOf @LTLengthOf("arr")}, and that is how it is treated internally by the checker.
 * Thus, if you write an {@code @IndexFor("arr")} annotation, you might see warnings about
 * {@code @NonNegative} or {@code @LTLengthOf}.
 *
 * @see org.checkerframework.checker.index.qual.NonNegative
 * @see org.checkerframework.checker.index.qual.LTLengthOf
